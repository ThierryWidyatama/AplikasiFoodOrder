...
public class ServerAPI {
   // public static String BASE_URL = "http://localhost/Server/";

    public static String BASE_URL = " https://thie13807ppb.000webhostapp.com/";
   // public static String BASE_URL = "http://10.0.2.2/ppb/uas";
   // public static String BASE_URL = "http://sambongrejouas.000webhostapp.com";
