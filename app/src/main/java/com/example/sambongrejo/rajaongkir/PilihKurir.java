package com.example.sambongrejo.rajaongkir;
...
import com.example.sambongrejo.CreateInvoiceActivity;
import com.example.sambongrejo.KeranjangActivity;
import com.example.sambongrejo.PembayaranActivity;
import com.example.sambongrejo.R;
import com.example.sambongrejo.rajaongkir.adapter.CityAdapter;
import com.example.sambongrejo.rajaongkir.adapter.ExpedisiAdapter;
import com.example.sambongrejo.rajaongkir.adapter.ProvinceAdapter;
import com.example.sambongrejo.rajaongkir.api.ApiService;
import com.example.sambongrejo.rajaongkir.api.ApiUrl;
...
import com.example.sambongrejo.rajaongkir.model.ekspedisi.ItemExpedisi;
import com.example.sambongrejo.rajaongkir.model.province.ItemProvince;
import com.example.sambongrejo.rajaongkir.model.province.Result;
...
public class PilihKurir extends AppCompatActivity {
    ...
    private List<com.example.sambongrejo.rajaongkir.model.city.Result> ListCity = new ArrayList<com.example.sambongrejo.rajaongkir.model.city.Result>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(PilihKurir.this, KeranjangActivity.class);
    ...
    public void popUpCity(final EditText etCity, final EditText etProvince) {
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Object o = mListView.getItemAtPosition(i);
                com.example.sambongrejo.rajaongkir.model.city.Result cn = (com.example.sambongrejo.rajaongkir.model.city.Result) o;
        ...
        call.enqueue(new Callback<ItemCity>() {
            ...
            public void onResponse(Call<ItemCity> call, Response<ItemCity> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    int count_data = response.body().getRajaongkir().getResults().size();
                    for (int a = 0; a <= count_data - 1; a++) {
                        com.example.sambongrejo.rajaongkir.model.city.Result itemProvince = new com.example.sambongrejo.rajaongkir.model.city.Result(
