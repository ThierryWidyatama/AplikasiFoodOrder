...
public class ProdukAdapter extends RecyclerView.Adapter<ProdukAdapter.MyViewHolder> {
    ...
    public ProdukAdapter(List<Ayam> list, Activity activity) {
        this.list = list;
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.tv_stok.setText("Stok " + String.valueOf(ayam.harga));
        Glide.with(holder.itemView)
                .load(list.get(position).getImage())
                .placeholder(R.drawable.fried_chicken_1)
                .error(R.drawable.fried_chicken_1)
                .centerCrop()
                .into(holder.gambar);
        ...
        holder.btn_edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(activity.getApplicationContext(), ProdukUpdateActivity.class);
        ...
        holder.btn_delete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AndroidNetworking.get(ServerAPI.PRODUK_DESTROY + "?id=" + ayam.id)
