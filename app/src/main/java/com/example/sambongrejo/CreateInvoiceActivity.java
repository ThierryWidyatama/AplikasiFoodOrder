...
public class CreateInvoiceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                        ...
                        .getAsJSONObject(new JSONObjectRequestListener() {
                            ...
                            public void onResponse(JSONObject response) {
                                try {
                                    ...
                                    if (value == 1){
                                        Toast.makeText(getApplicationContext(), "Selesaikan pembayaran Anda!", Toast.LENGTH_SHORT).show();
                                        int id = response.getInt("id");
                                        Intent intent = new Intent(CreateInvoiceActivity.this, PembayaranActivity.class);
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(CreateInvoiceActivity.this, KeranjangActivity.class);
                startActivity(intent);
            }
        });
    }
