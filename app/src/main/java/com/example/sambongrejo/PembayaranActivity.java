...
public class PembayaranActivity extends AppCompatActivity {
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            tv_total.setText(String.valueOf("Rp. " + total));
    ...
    private void createPDF() throws FileNotFoundException {
        ...
        for (Ayam ayam : list) {
            table.addCell(new Cell().add(new Paragraph(ayam.nama)));
            table.addCell(new Cell().add(new Paragraph(String.valueOf(ayam.berat))));
            table.addCell(new Cell().add(new Paragraph("Rp. " + String.valueOf(ayam.harga))));
        }
        ...
        table.addCell(new Cell().add(new Paragraph("Rp. " + String.valueOf(ongkir)).setTextAlignment(TextAlignment.RIGHT)).setBorder(Border.NO_BORDER));

        table.addCell(new Cell().add(new Paragraph()).setBorder(Border.NO_BORDER));
        table.addCell(new Cell(1, 2).add(new Paragraph("Total Bayar \n Rp. " + String.valueOf(total)).setFontSize(14f).setBold().setTextAlignment(TextAlignment.CENTER)).setBorder(Border.NO_BORDER));
        document.add(table);
